...
export default class XyDataCreate extends SfdxCommand {
  public static description = 'create sobject';

  public static examples = [
    'sf xy data create --sobject Account --file Account.json',
    'sf xy data create -s Account -f Account.json',
    'echo Account.json | sf xy data create -s Account',
  ];
  ...
  public async run(): Promise<any> {
    ...
    this.ux.startSpinner(`start to create ${this.flags.sobject}`);
